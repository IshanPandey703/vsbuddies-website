        ...
        <div className="Home">
            <div id="home" className="home-container">
                <div className="home-container-main">
                    ...
                    <Button id="get-started-btn" variant="outlined" onClick={props.func}>
                        Get Started!
                    </Button>
                </div>
            </div>
            <svg className="cloud" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 319"><path fill="#fff" fillOpacity="1" d="M0,160L30,181.3C60,203,120,245,180,224C240,203,300,117,360,101.3C420,85,480,139,540,165.3C600,192,660,192,720,165.3C780,139,840,85,900,53.3C960,21,1020,11,1080,10.7C1140,11,1200,21,1260,64C1320,107,1380,181,1410,218.7L1440,256L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z" data-darkreader-inline-fill=""></path></svg>
