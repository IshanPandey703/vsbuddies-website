...
const interests = ["Action Script","Aerospace","AIML","Algorithm","AngularJS","Animation","Anime","Arduino","Artificial Intelligence","Astronomy","AWS", "Back-End Development","Backbone.js","Badminton","BGMI","BlockChain","Blogging","Board Games","Bodybuilding","Bootstrap","Business","C","C#","Chess","Cloud Computing","COD","Competitive Programming","Content Writing","CPP","Cricket","CSGO","CSS","Data Structure","Designing","Django","Docker","Emacs","Ember.js","Entrepreneurship","Esports","ExpressJS","F1","Field Hockey","Firebase","Flask","Flutter","Football", "Front-End Development","Gaming","Git","GO","Graphic Designing","GraphQL","GSAP","Gym","Haskell","HTML","Investing","Java","JavaScript","jQuery","JSON","Julia","Kotlin","Laravel","laTEX","Life Science","LINQ","Linux","Lisp","Lua","Machine Learning","Marketing","MATLAB","MongoDB","Mongoose","Motorcycling","Movies","MUI","Music","MySQL","Next.js","Node.js","Objective-C","Painting","Photography","PHP","Podcast","Poetry","Python","Qt","Quizzes","R","Rails","Raspberry Pi","React.js","React Native","Reading","Research","REST","Ruby","Rust","SASS","Scala","Science","Semantic-UI","Singing","Sports","Spring","SQL","Swift","threejs","Tourism","TypeScript","Valorant","Video Editing","Videography","Video making","Vue.js","Web Development","Wolfram Language","WordPress","Wrestling","Writing music","XML","XQuery"];

export {collegeList,interests};